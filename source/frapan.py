...
class Frapan:
    ...
    def __init__(self, path, adhoc_config={}):
        ...
        # If some properties are left unfilled, config expands using loaded images:
        self.expand_config()
    ...
    def save_mean_profiles(self):
        ...
        path = rslt_dir + 'mean-profiles.tif'
    ...
    def plot_approximation_parameters_over_time(self):
        ...
        plt.savefig(rslt_dir + f'parameters.png', dpi=300)
        plt.close()
    ...
    def plot_approximation_errors_over_time(self):
        ...
        plt.savefig(rslt_dir + f'errors.png', dpi=300)
        plt.close()
